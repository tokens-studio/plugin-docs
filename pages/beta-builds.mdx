...
Then click on Link existing plugin and navigate to where you downloaded the ZIP File. Select the `manifest.json` file.

![](/choose-manifest.jpg)

That's it! You now got a development build of Figma Tokens. Start it by right clicking anywhere in a document and choose `Figma Tokens (Dev)`
