...
Instale o plugin Tokens Studio for Figma clicando no botão `Install` [nesta página](https://www.figma.com/community/plugin/843461159747178978/Figma-Tokens) (no Figma cliente ou no navegador)
