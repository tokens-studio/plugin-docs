...
Once logged in, click on your avatar and select "API-Keys". There you'll find your Secret Key. Copy that and insert it into the `Secret` field in Tokens Studio for Figma.
